...
const REGISTRY_FILE = path.join(process.cwd(), 'src', 'migration-registry.json')

// Create Hygraph client
const client = new Client({
  endpoint: process.env.HYGRAPH_MANAGEMENT_API as string,
  authToken: process.env.HYGRAPH_MANAGEMENT_API_TOKEN as string,
})
